...
export default function FoodDining() {
  ...
  const { data: businesses = [], isLoading } = useQuery({
    queryKey: ["businesses", "Food & Dining"],
    queryFn: () => base44.entities.Business.filter({ category: "Food & Dining" }),
  });
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-orange-50 to-red-50 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Restaurants and culinary experiences</p>
            </div>
          </div>
          ...
          {/* Price Range Key */}
          <Card className="mt-6 p-6 bg-white/90 backdrop-blur-sm border-orange-100 shadow-md max-w-xl">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-500">
              {searchQuery ? "Try a different search term" : "Check back soon for restaurant listings"}
            </p>
          </div>
        )}
      </section>
