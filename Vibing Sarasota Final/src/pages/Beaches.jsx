...
export default function Beaches() {
  ...
  const { data: businesses = [], isLoading } = useQuery({
    queryKey: ["businesses", "Beaches"],
    queryFn: () => base44.entities.Business.filter({ category: "Beaches" }),
  });
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-cyan-50 to-blue-50 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Pristine white sand beaches</p>
            </div>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">
              {searchQuery ? "No beaches found" : "No beaches yet"}
            </h3>
            <p className="text-gray-500">
              {searchQuery ? "Try a different search term" : "Check back soon for beach listings"}
            </p>
          </div>
        )}
      </section>
